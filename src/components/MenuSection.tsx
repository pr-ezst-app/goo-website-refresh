...
export const MENU_ITEMS = [
  ...
  { id: 12, category: "Burgers", name: "Deluxe", price: 0, badge: null, desc: "Bacon, cheddar", emoji: "🥓" },
  { id: 13, category: "Burgers", name: "Veggie", price: 0, badge: "🌿 Vegan", desc: "Veggie patty, mozzarella, sautéed", emoji: "🥦" },
